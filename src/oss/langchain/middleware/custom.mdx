...
<figure>
  ...
  <figcaption>Based on the <a href="https://github.com/langchain-ai/langchain/blob/81c4f21b5297b31b2cd82ccefdd134aa0e59efa0/libs/langchain_v1/langchain/agents/factory.py">langchain/libs/langchain_v1/langchain/agents/factory.py</a>.</figcaption>
</figure>
